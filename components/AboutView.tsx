    ...
    <div className="w-full bg-black text-white py-32 px-6 md:px-12 relative overflow-hidden">
      ...
      <div className="container mx-auto max-w-6xl relative z-10">
        ...
        >
          ...
          <h2 className="text-4xl md:text-7xl lg:text-[5.5rem] leading-[1.05] font-tight font-medium tracking-tight mix-blend-screen">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16 mt-32 border-t border-white/10 pt-16">
             <div>
